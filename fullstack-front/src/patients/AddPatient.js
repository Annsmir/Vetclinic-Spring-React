...
const AddPatient = () => {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    await axios.post("http://localhost:8090/new_patient", formValues)
    navigate("/patients")
  };
    ...
    <div className='container'>
      <div className='row'>
        <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
          <h2 className='text-center m-4'>Информация о пациенте</h2>
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className='mb-1'>
              <label htmlFor='PatientBirthday' className='form-label'>
                Дата рождения
              </label>
